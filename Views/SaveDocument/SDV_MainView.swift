...
// Main view for SaveDocumentView - extracted as part of Phase 3 refactoring
// This maintains UI consistency with DocumentDetailView for tag and folder management
extension Views_SaveDocument {
    struct SDV_MainView: View {
        ...
        var body: some View {
                ...
                NavigationView {
                    Form {
                        ...
                        SDV_TitleView(
                            ...
                            showAIConfirmation: .constant(false)
                        )
            ...
            .onAppear {
                // Set up notification observers for hiding confirmations
